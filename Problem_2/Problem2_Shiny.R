...
# https://www.rdocumentation.org/packages/maps/versions/3.3.0/topics/map

## read & filter data
sites <- read.csv("/Users/laura/Desktop/BU/Course/615/R/MSSP_MA_615_HW/Mapping_Assignment/MA_615_Mapping_Assignment/Colleges_and_Universities.csv") 
sites %<>% filter(Longitude!=0 | Latitude!=0)
...
food_trunk <- read.csv("/Users/laura/Desktop/BU/Course/615/R/MSSP_MA_615_HW/Mapping_Assignment/MA_615_Mapping_Assignment/food_truck_schedule.csv")
